"""Archived subjective belief reports from one legal observation."""
...
class BeliefReporter:
    ...
    def legal_state(
        ...
        return legal_observer_state(observer_id, observation)
    ...
    def derive_hard_knowledge(
        ...
        return derive_observer_hard_knowledge(observer_id, observation)
